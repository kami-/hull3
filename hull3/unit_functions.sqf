...
hull3_unit_fnc_killMessage = {
    ...
    _message = switch(true) do 
    {
        ...
        default { format["You were killed by %1 from %2 metres away with %3 (%4), on team %5. You are on team %6.", name _killer, (round (_unit distance _killer)), _text, _projectile, side(group(_killer)), playerSide]; };
    };
