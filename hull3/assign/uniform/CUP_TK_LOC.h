class CUP_TK_LOC {
    class Rifleman {
        ...
        vest = "CUP_V_OI_TKI_Jacket4_06";
        backpack = "CUP_B_AlicePack_Khaki";
    };

    class Leader : Rifleman {
        uniform = "CUP_O_TKI_Khet_Jeans_04";
        vest = "CUP_V_OI_TKI_Jacket1_04";
