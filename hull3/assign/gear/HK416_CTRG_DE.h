class HK416_CTRG_DE {
    class Rifleman {
        ...
        primaryWeaponItems[] = {"optic_Holosight", "RH_SFM952V_tan"};
        secondaryWeapon = "";
    ...
    class Crew : Rifleman {
        ...
        primaryWeaponItems[] = {"RH_SFM952V_tan"};
        uniformMagazines[] = {
            {"ACE_Chemlight_HiRed", 2},
            {"SmokeShell", 1}
        };
    ...
    class ENG : Rifleman {
        primaryWeaponItems[] = {"RH_compM2", "RH_SFM952V_tan"};
        vestMagazines[] = {
            {"30Rnd_556x45_Stanag", 6},
            {"30Rnd_556x45_Stanag_Tracer_Red", 2}
        };
    ...
    class SN : Rifleman {
        ...
        primaryWeaponItems[] = {"optic_Hamr", "bipod_01_F_snd", "RH_SFM952V_tan"};
        vestMagazines[] = {
            {"20Rnd_762x51_Mag", 4},
            {"9Rnd_45ACP_Mag", 3}
        };
