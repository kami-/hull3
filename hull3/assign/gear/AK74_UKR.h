class AK74_UKR {
    ...
    class AR : Rifleman {
        ...
        primaryWeaponItems[] = {"CUP_acc_Flashlight", "CUP_optic_Kobra"};
        vestMagazines[] = {{"CUP_60Rnd_TE1_Red_Tracer_545x39_AK74M_M", 2}};
        backpackMagazines[] = {
            {"HandGrenade", 1},
            {"SmokeShell", 1},
            {"CUP_60Rnd_TE1_Red_Tracer_545x39_AK74M_M", 6}
        };
    };
    ...
    class Truck : Vehicle {
        ...
        magazines[] = {
            ...
            {"CUP_30Rnd_TE1_Red_Tracer_545x39_AK_M", 20},
            {"CUP_60Rnd_TE1_Red_Tracer_545x39_AK74M_M", 20},
