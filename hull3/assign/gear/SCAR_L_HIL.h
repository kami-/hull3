class SCAR_L_HIL {
    class Rifleman {
        primaryWeapon = "CUP_arifle_Mk16_CQC_woodland";
    ...
    class AR : Rifleman {
        primaryWeapon = "CUP_lmg_M60E4_jungle";
        primaryWeaponItems[] = {};
    ...
    class MATG : RAT {
        ...
        secondaryWeaponItems[] = {"CUP_optic_SMAW_Scope", "MRAWS_HEAT_F"};
        backpackMagazines[] = {
            {"CUP_SMAW_HEAA_M", 2},
            {"CUP_SMAW_HEDP_M", 1},
            {"CUP_SMAW_Spotting", 2}
    ...
    class SN : Rifleman {
        primaryWeapon = "CUP_arifle_Mk16_SV_woodland";
        handgunWeapon = "CUP_hgun_M9";
        primaryWeaponItems[] = {"CUP_optic_Elcan_SpecterDR_KF_od", "CUP_bipod_VLTOR_Modpod_od"};
        vestMagazines[] = {
            {"CUP_30Rnd_556x45_PMAG_QP", 4},
            {"CUP_15Rnd_9x19_M9", 3}
        };
    ...
    class Vehicle {
        weapons[] = {
            {"CUP_arifle_Mk16_CQC_woodland", 2},
            {"CUP_launch_APILAS", 4}
        };
        magazines[] = {
