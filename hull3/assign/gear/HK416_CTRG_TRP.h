class HK416_CTRG_TRP {
    class Rifleman {
        primaryWeapon = "arifle_SPAR_01_khk_F";
        primaryWeaponItems[] = {"optic_Holosight_khk_F", "RH_SFM952V"};
        secondaryWeapon = "";
    ...
    class SN : Rifleman {
        ...
        primaryWeaponItems[] = {"optic_Hamr_khk_F", "bipod_01_F_blk", "RH_SFM952V"};
        vestMagazines[] = {
            {"20Rnd_762x51_Mag", 4},
            {"9Rnd_45ACP_Mag", 3}
        };
