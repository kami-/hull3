class AKM_PRL_AIR {
    ...
    class Medic : Rifleman {
        ...
        backpackMagazines[] = {
            {"SmokeShellBlue", 4},
            {"gm_25Rnd_9x18mm_B_pst_pm63_blk", 2}
        };
        assignItems[] = {"ItemGPS"};
        binocular = "Binocular";
        uniformRadios[] = {"ACRE_PRC343", "ACRE_PRC152"};
    ...
    class HMGG : Rifleman {
        primaryWeapon = "gm_pm63_blk";
        vestMagazines[] = {{"gm_25Rnd_9x18mm_B_pst_pm63_blk", 8}};
    ...
    class Vehicle {
        ...
        magazines[] = {
            ...
            {"gm_25Rnd_9x18mm_B_pst_pm63_blk", 20},
            {"CUP_PG7VL_M", 2},
    ...
    class Truck : Vehicle {
        ...
        magazines[] = {
            ...
            {"gm_100Rnd_762x54mm_B_T_t46_pk_grn", 50},
